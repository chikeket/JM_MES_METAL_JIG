...
ALTER TABLE wrhous_wrhsdlvr_mas DROP COLUMN LOT_INVNTRY_PRECON_ID;

ALTER TABLE wrhous_wrhsdlvr_mas DROP CONSTRAINT FK_LOT_INVNTRY_PRECON_ID;

ALTER TABLE wrhous_wrhsdlvr_mas ADD COLUMN RCVPAY_NM VARCHAR(100) NOT NULL;

ALTER TABLE lot_stc_precon DROP CONSTRAINT FK_LSTC__WW;

ALTER TABLE lot_stc_precon CHANGE COLUMN WRHOUS_WRHSDLVR_ID WRHSDLVR_MAS_ID VARCHAR(100);

ALTER TABLE lot_stc_precon ADD CONSTRAINT FK_MAS_ID FOREIGN KEY (WRHSDLVR_MAS_ID) REFERENCES wrhous_wrhsdlvr_mas(wrhsdlvr_mas_id);
...
ALTER TABLE BOM
ADD UNIQUE KEY uq_bom_ver (prdt_id, prdt_opt_id, bom_ver);