...
const getWarehouseByItemType = async (Info) => {
  ...
  console.log(
    "[warehouse_service] getWarehouseByItemType - itemType:",
    itemType
  );
  ...
  try {
    ...
    console.log(
      "[warehouse_service] 창고 조회 결과:",
      result?.length || 0,
      "건"
    );
    return result || [];
  } catch (error) {
    console.error("[warehouse_service] 창고 조회 오류:", error);
    return [];
  }
};
...
const getLocationByItemType = async (Info) => {
  ...
  console.log(
    "[warehouse_service] getLocationByItemType - itemType:",
    itemType,
    "warehouseId:",
    warehouseId
  );
  ...
  try {
    ...
    console.log(
      "[warehouse_service] 로케이션 조회 결과:",
      result?.length || 0,
      "건"
    );
    return result || [];
  } catch (error) {
    console.error("[warehouse_service] 로케이션 조회 오류:", error);
    return [];
  }
};
...
const getAllWarehouses = async () => {
  try {
    ...
    console.log(
      "[warehouse_service] 전체 창고 조회 결과:",
      result?.length || 0,
      "건"
    );
    return result || [];
  } catch (error) {
    console.error("[warehouse_service] 전체 창고 조회 오류:", error);
    return [];
  }
};
...
const getAllLocations = async () => {
  try {
    ...
    console.log(
      "[warehouse_service] 전체 로케이션 조회 결과:",
      result?.length || 0,
      "건"
    );
    return result || [];
  } catch (error) {
    console.error("[warehouse_service] 전체 로케이션 조회 오류:", error);
    return [];
  }
};
...
const getLocationsByWarehouse = async (Info) => {
  ...
  console.log(
    "[warehouse_service] getLocationsByWarehouse - warehouseId:",
    warehouseId
  );
  ...
  try {
    ...
    console.log(
      "[warehouse_service] 창고별 로케이션 조회 결과:",
      result?.length || 0,
      "건"
    );
    return result || [];
  } catch (error) {
    console.error("[warehouse_service] 창고별 로케이션 조회 오류:", error);
    return [];
  }
};
