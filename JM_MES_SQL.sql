...
CREATE TABLE deli (
	...
	emp_id	VARCHAR(100)	NOT NULL	COMMENT '사원 테이블 FK',
	deli_dt	DATE	NOT NULL	DEFAULT CURRENT_TIMESTAMP,
	rm	VARCHAR(1000)	NULL
);

CREATE TABLE deli_deta (
	deli_deta_id	VARCHAR(100)	NOT NULL,
	deli_id	VARCHAR(100)	NOT NULL,
	rcvord_id	VARCHAR(100)	NOT NULL	COMMENT '수주 상세 테이블 식별자',
...
ALTER TABLE deli_deta ADD CONSTRAINT PK_deli_deta PRIMARY KEY (
	deli_deta_id
);
...
ALTER TABLE deli ADD CONSTRAINT PK_deli PRIMARY KEY (
	deli_id
);
