  ...
  <div class="procctrl-page">
    ...
    <div class="row-layout">
      ...
      <div class="section-group">
        <div class="section-title">생산 지시 정보</div>
...
<div class="row-layout">
  ...
  <!-- 설비 및 금형 정보 -->
  <div class="section-group">
    <div class="section-title">설비 및 금형 정보</div>
    <div class="section-card">
      <div class="grid grid-2">
        <div class="field-set">
        ...
        <div class="field-set" style="grid-column: span 2;">
...
<div class="row-layout">
  <!-- 수량 정보 -->
  <div class="section-group">
    <div class="section-title">수량 정보</div>
    <div class="section-card">
      <div class="grid grid-2">
        <div class="field-set">
  ...
  <div class="section-group">
    ...
    <div class="section-card">
      <div class="grid grid-2">
        ...
        <div class="field-set highlight" style="grid-column: span 2;">
    ...
    <div class="actions-centered">
      ...
      <button class="btn btn-outline-danger" type="button" @click="stopTimer">
        작업 종료
      </button>
...
.field-set input:not([readonly]):focus,
.field-set select:not(:disabled):focus {
  border-color: #64748b;
  box-shadow: 0 0 0 2.5px rgba(100, 116, 139, 0.1);
  outline: none;
}

.field-set.highlight input {
  border-color: #fbbf24;
  background: #fffbeb;
}

.field-set.highlight input:focus {
  border-color: #f59e0b;
  box-shadow: 0 0 0 2.5px rgba(251, 191, 36, 0.2);
}
