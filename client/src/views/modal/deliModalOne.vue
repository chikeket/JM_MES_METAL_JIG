<template>
  <CModal :visible="visible" @close="close" size="xl">
    <CModalHeader class="modal-header-custom">
      <CModalTitle class="modal-title-custom">납품 조회</CModalTitle>
    </CModalHeader>
          ...
          <div class="search-row-container">
            <div class="search-input-group">
              ...
              <input
                ...
                @keyup.enter="searchDeli"
              />
            </div>

            <div class="button-group">
              <button class="btn-search-modal" @click="searchDeli">조회</button>
            ...
            <table class="data-table-modal">
              <thead>
                <tr>
                  ...
                  <th style="width: 18%">납품 ID</th>
                  <th style="width: 20%">납품 담당자</th>
                  <th style="width: 18%">납품 등록 일자</th>
                  <th style="width: 14%">납품 상태</th>
                  <th style="width: 25%">비고</th>
                </tr>
              </thead>
              <tbody>
                <tr v-if="deliList.length === 0" class="empty-state">
                  <td colspan="6">납품 ID를 입력하고 조회 버튼을 클릭하세요</td>
                </tr>
                <tr
                ...
                >
                  ...
                  <td class="text-left">{{ row.deli_id }}</td>
                  <td class="text-left">{{ row.emp_nm }}</td>
                  <td class="text-center">{{ formatDate(row.deli_dt) }}</td>
...
const fetchAll = async () => {
  try {
    ...
    const params = keyword ? { deli_id: keyword } : {}
