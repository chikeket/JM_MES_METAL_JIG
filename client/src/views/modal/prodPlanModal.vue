...
const prdtSearch = async () => {
  ...
  if (pickValue.value == 'singleDate') {
    ...
    params.prod_expc_to_dt = '2125-01-01';
      ...
      params.reg_dt = '1970-01-01';
    if(prod_expc_fr_dt.value != null && prod_expc_to_dt.value == null) {
        params.prod_expc_fr_dt = prod_expc_fr_dt.value;
        params.prod_expc_to_dt = '2125-01-01';
    }else if(prod_expc_fr_dt.value == null && prod_expc_to_dt.value != null) {        
        params.prod_expc_fr_dt = '1970-01-01';
  ...
  // console.log(params)
  let result = await axios.get('/api/prodPlanSearch', { params }).catch((err) => console.log(err))
