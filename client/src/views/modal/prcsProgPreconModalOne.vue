<template>
  <CModal :visible="visible" @close="onClose" size="xl">
    <CModalHeader class="modal-header-custom">
      <CModalTitle class="modal-title-custom">지시 조회</CModalTitle>
    </CModalHeader>
        ...
        <div class="search-section">
          <div class="search-row-container">
            ...
            <div class="button-group">
              <button class="btn-search-modal" @click="fetchOrders">조회</button>
            ...
            <table class="data-table-modal">
              <thead>
                <tr>
                  ...
                  <th style="width: 12%">지시 ID</th>
                  <th style="width: 18%">지시 명</th>
                  <th style="width: 12%">지시 담당자</th>
                  <th style="width: 12%">지시 시작 일자</th>
                  <th style="width: 15%">지시 종료 예정 일자</th>
                  <th style="width: 12%">지시 등록 일자</th>
              ...
              <tbody>
                ...
                >
                  ...
                  <td class="text-left">{{ row.prod_drct_id }}</td>
                  <td class="text-left text-ellipsis" :title="row.prod_drct_nm">
                    {{ row.prod_drct_nm }}
                  </td>
                  <td class="text-left">{{ row.emp_nm }}</td>
                  <td class="text-center">{{ fmtDate(row.prod_drct_fr_dt) }}</td>
                  <td class="text-center">{{ fmtDate(row.prod_drct_to_dt) }}</td>
                  <td class="text-center">{{ fmtDate(row.reg_dt) }}</td>
