<template>
  <CModal :visible="visible" @close="close" size="xl">
    <CModalHeader class="modal-header-custom">
      <CModalTitle class="modal-title-custom">반제품 품질조회</CModalTitle>
    </CModalHeader>
        ...
        <div class="table-section">
          <div class="table-wrapper-modal">
            <table class="data-table-modal">
              <thead>
                <tr>
                  <th style="width: 20%">검사자</th>
                  <th style="width: 20%">검사 수량</th>
                  <th style="width: 20%">합격 수량</th>
                  <th style="width: 20%">불량 수량</th>
                  <th style="width: 20%">검사 일자</th>
                </tr>
              </thead>
              <tbody>
                <tr 
