  ...
  <CTable hover bordered small class="align-middle">
    <CTableHead color="dark">
      <CTableRow>
        ...
        <CTableHeaderCell scope="col">규격</CTableHeaderCell>
        <CTableHeaderCell scope="col" class="text-end" style="width: 140px">단위</CTableHeaderCell>
        <CTableHeaderCell scope="col" style="width: 120px">계획수량</CTableHeaderCell>
        <CTableHeaderCell scope="col" style="width: 90px">지시수량</CTableHeaderCell>
        <CTableHeaderCell scope="col" style="width: 140px">기지시수량</CTableHeaderCell>
        <CTableHeaderCell scope="col">미지시수량</CTableHeaderCell>
    ...
    <CTableBody>
      <CTableRow v-for="(row, idx) in rows" :key="row.id ?? idx">
        <!-- 코드 명 -->
        <CTableHeaderCell scope="row" class="text-center">{{ row.id }}</CTableHeaderCell>

        <!-- 제품 명 -->
        <CTableHeaderCell scope="row" class="text-center">{{ row.name }}</CTableHeaderCell>
